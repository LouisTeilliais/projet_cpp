rpg : main.o Character.o Mage.o Barbarian.o exception.o potion.o Priest.o Monster.o game.o
	g++ main.o Character.o Mage.o Barbarian.o exception.o potion.o Priest.o Monster.o game.o -o rpg
