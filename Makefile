rpg : main.o Character.o Mage.o Barbarian.o exception.o potion.o Priest.o Start.o
	g++ main.o Character.o Mage.o Barbarian.o exception.o potion.o Priest.o Start.o -o rpg
